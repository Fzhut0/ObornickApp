...
namespace API.Data.Migrations
{
    ...
    [Migration("20240515173306_AddRecipeDescriptionStepOrder")]
    partial class AddRecipeDescriptionStepOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.RecipeModuleEntities.RecipeDescriptionStep", b =>
                {
                    b.Property<int>("DescriptionStepId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DescriptionStepId"));
                    ...
                    b.ToTable("RecipeDescriptionSteps");
                });
            ...
            modelBuilder.Entity("API.Entities.RecipeModuleEntities.RecipeDescriptionStep", b =>
                {
                    b.HasOne("API.Entities.Recipe", null)
                        .WithMany("RecipeDescriptionSteps")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("API.Entities.Recipe", b =>
                {
                    b.Navigation("RecipeDescriptionSteps");
